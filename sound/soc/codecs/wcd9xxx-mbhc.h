...
#define PTT_SW_GPIO 54
#define PTT_SW_LEVEL_PUSH 0
#define PTT_SW_POLLING_ONE_TIME 25
#define PTT_SW_POLLING_PRESS_TIME 120
#define PTT_SW_POLLING_RELEASE_TIME 450
#define PTT_SW_POLLING_PUSH_CNT 5
#define PTT_SW_POLLING_RELEASE_CNT 2
enum ptt_sw_state {
	PTT_SW_STATE_IDLE,
	PTT_SW_STATE_PRESS_WAIT,
	PTT_SW_STATE_PRESS_KEEP,
	PTT_SW_STATE_RELEASE_WAIT,
};
#endif
...
#ifdef CONFIG_KYOCERA_MSND_PTT
	unsigned int gpio_irq_ptt;
	int gpio_level_push_ptt;
	int ptt_irq_state;
	int ptt_poll_state;
	int ptt_poll_cnt;
	int ptt_sw_state;
...
#ifdef CONFIG_KYOCERA_MSND_PTT
	struct delayed_work mbhc_ptt_sw_dwork;
	struct delayed_work mbhc_ptt_sw_wait_dwork;
#endif
