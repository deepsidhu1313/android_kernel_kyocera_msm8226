...
static struct clkctl_acpu_speed acpu_freq_tbl_8226_1p1[] = {
	...
	{ 1,  787200, ACPUPLL, 5, 0,   CPR_CORNER_4, 0, 6 },
        ...
        { 1,  902400, ACPUPLL, 5, 0,   CPR_CORNER_12,  0, 7 },
        { 1,  940800, ACPUPLL, 5, 0,   CPR_CORNER_12,  0, 7 },
...
static struct clkctl_acpu_speed acpu_freq_tbl_8226_1p6[] = {
	...
	{ 1,  787200, ACPUPLL, 5, 0,   CPR_CORNER_4, 0, 6 },
        ...
        { 1,  902400, ACPUPLL, 5, 0,   CPR_CORNER_5,  0, 7 },
        { 1,  940800, ACPUPLL, 5, 0,   CPR_CORNER_5,  0, 7 },
