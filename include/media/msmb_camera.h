...
#define MSM_CAMERA_SESSION_CHECK (MSM_CAMERA_EVENT_MIN + 8)
...
#define MSM_CAMERA_PRIV_I2C_ERROR   (V4L2_CID_PRIVATE_BASE + 14)
#define MSM_CAMERA_PRIV_TIMEOUT_ERROR   (V4L2_CID_PRIVATE_BASE + 15)
