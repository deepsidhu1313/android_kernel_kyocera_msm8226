...
struct panel_pp_info{
	...
	u32 pcc_g;
	u32 pcc_b;
	u32 r_stage_enable[NUM_ARGC_STAGES];
	u32 g_stage_enable[NUM_ARGC_STAGES];
	u32 b_stage_enable[NUM_ARGC_STAGES];
	u32 r_x_start[NUM_ARGC_STAGES];
	u32 r_slope[NUM_ARGC_STAGES];
	u32 r_offset[NUM_ARGC_STAGES];
	u32 g_x_start[NUM_ARGC_STAGES];
	u32 g_slope[NUM_ARGC_STAGES];
	u32 g_offset[NUM_ARGC_STAGES];
	u32 b_x_start[NUM_ARGC_STAGES];
	u32 b_slope[NUM_ARGC_STAGES];
	u32 b_offset[NUM_ARGC_STAGES];
	u32 igc_c0_c1_data[IGC_LENGTH];
	u32 igc_c2_data[IGC_LENGTH];
	u32 pa_v2_six_zone_curve_p0[MDP_SIX_ZONE_LUT_SIZE];
	u32 pa_v2_six_zone_curve_p1[MDP_SIX_ZONE_LUT_SIZE];
};
