...
#define OEM_SUBSTRATE_THERM_DISABLE

#define OEM_HKADC_MONITOR_TIME_MS		1000

#define HKADC_ELEMENT_COUNT				5

#define HKADC_SUSPEND_MONITOR_FREQ		(3 * 60)

#define HKADC_THERM_MONITOR_FREQ		5

#define USB_THERM_WARNING_TEMP	(60 * 10)
