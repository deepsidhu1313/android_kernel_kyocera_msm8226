                           ...
                           const struct i2c_device_id *id)
{
        ...
        dev_dbg(&client->dev, "-------------------bcm2079x_probe [Start]---------------------\n");
        ...
        msleep(300);                                     /* Wait time after REG_PU High for BCM20795 */
